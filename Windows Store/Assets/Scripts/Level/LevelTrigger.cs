...
public class LevelTrigger : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        if (GameObject.Find("TextureLoader") != null)
        {
            ...
            toMenuWinTexture = textureLoader.getTexture("WinScreen");
            toMenuLoseTexture = textureLoader.getTexture("LoseScreen");
            notEnoughCrystalsTexture = textureLoader.getTexture("Not Enough Crystals");
        }
