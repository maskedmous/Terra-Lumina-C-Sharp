...
public class Menu : MonoBehaviour
{
    ...
    public void animateMenu(string buttonName)
    {
        ...
        foreach (Button menuButton in buttonList)
        {
            ...
            {
                movingButtonList.Add(menuButton);
            }
            else
            {
    ...
    public void Update()
    {
        ...
        if (menuAnimation != "")
        {
            ...
            if (menuButton.xPosition >= 0 - menuButton.widthOfTexture)
            {
                //calculate the movement speed
                buttonMoveSpeed = menuButton.xPositionButton + menuButton.widthOfTexture;
                //apply the speed
                menuButton.xPosition -= (buttonMoveSpeed * 5) * Time.deltaTime;
            }
            else if (buttonAnimationIterator < (movingButtonList.Count - 1))
            {
                buttonAnimationIterator++;
            }
            else if (lastButton.xPosition >= 0 - lastButton.widthOfTexture)
            {
                //calculate the movement speed
                buttonMoveSpeed = menuButton.xPositionButton + menuButton.widthOfTexture;
                //apply the speed
                lastButton.xPosition -= (buttonMoveSpeed * 5) * Time.deltaTime;
            }
            else
            {
                animationDone = true;
